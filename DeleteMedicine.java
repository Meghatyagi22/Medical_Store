...
public class DeleteMedicine extends JFrame implements ActionListener
{
	...
	DeleteMedicine()
	{
	   ...
	   //ln.setForeground(new java.awt.Color(0,204,255));
	    ln.setBounds(300,30,300,40);
	    jf.add(ln);

		l1 = new JLabel("Medicine Batch no* :");
		l1.setFont(f);
		//l1.setForeground(new java.awt.Color(153,0,255));
        l1.setBounds(50,100,200,25);
		jf.add(l1);

		t1 = new JTextField(20);
		t1.setBounds(250,100,100,25);
		t1.setToolTipText("Enter medicine batch no to delete medicine");
		jf.add(t1);

		l2 = new JLabel("Medicine name* :");
		l2.setFont(f);
        l2.setBounds(50,140,200,25);
       // l2.setForeground(new java.awt.Color(153,0,255));
		jf.add(l2);

    	t2 = new JTextField(20);
		t2.setBounds(250,140,200,25);
		t2.setToolTipText("Enter medicine name to delete medicine");
		jf.add(t2);

		l3 = new JLabel("Medicine company :");
		l3.setFont(f);
        l3.setBounds(50,180,200,25);
       // l3.setForeground(new java.awt.Color(153,0,255));
		jf.add(l3);
      ...
      // l4.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l4);
       ...
       // l5.setForeground(new java.awt.Color(153,0,255));
		jf.add(l5);
      ...
      //  l6.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l6);
       ...
       // l7.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l7);
      ...
      //  l8.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l8);
      ...
      //  l9.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l9);
		...
		l10.setFont(f);
  	   ...
  	   // l10.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l10);
     ...
     //   l11.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l11);
      ...
      //  l12.setForeground(new java.awt.Color(153,0,255));
    	jf.add(l12);
        ...
        lb = new JLabel(new ImageIcon("pics//pic17.jpg"));
