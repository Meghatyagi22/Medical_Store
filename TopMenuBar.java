...
public class TopMenuBar extends JMenuBar {
	...
	public TopMenuBar(medicalstore.Frame parentFrame) {
		...
		addMedicine.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				addAnotherPanel(parentFrame, new AddNewMedicine());
			}
		});
		...
		updateInventory.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				addAnotherPanel(parentFrame, new UpdateInvertory(parentFrame));
			}
		});
	...
	public void addAnotherPanel(Frame frame, AddNewMedicine addNewMedicine) {
		frame.remove(frame.currentPanel);
		frame.currentPanel = addNewMedicine;
